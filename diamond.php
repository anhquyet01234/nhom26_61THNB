        ...
        foreach ($results as $item) {
            ...
            <div class="item-job Underline">
                ...
                <div class="JobSearchCard-secondary">
                    ...
                    <div class="JobSearchCard-ctas mt-3">
                        <a href="main.php?assign_id=<?php echo $item['id'] ?>" class="JobSearchCard-ctas-btn btn btn-mini btn-success">
                            Nhận việc ngay </a>
                        <?php if ($_SESSION['userId'] === $item['user_id']) { ?>
                            <a href="main.php?page=handle-job&id=<?php echo ($item['id']) ?>" class="JobSearchCard-ctas-btn btn btn-mini btn-warning mt-3">
                                Cập nhật</a>
                        <?php } ?>
                    </div>
                </div>
